...
public class TNTtrailsClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		ScreenEvents.AFTER_INIT.register((client, screen, width, height) -> {
			if (screen instanceof OptionsScreen && Screens.getWidgets(screen).stream()
					.noneMatch(widget -> widget.getMessage().getString().equals("TNT Trails"))) {
				Screens.getWidgets(screen).add(Button.builder(Component.literal("TNT Trails"),
